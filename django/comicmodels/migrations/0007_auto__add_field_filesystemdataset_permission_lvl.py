...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FileSystemDataset.permission_lvl'
        db.add_column('comicmodels_filesystemdataset', 'permission_lvl',
                      self.gf('django.db.models.fields.CharField')(default='ALL', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FileSystemDataset.permission_lvl'
        db.delete_column('comicmodels_filesystemdataset', 'permission_lvl')
