...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        def create_demo_benchmark(user: User, evaluator: Algorithm, test_data: DataFile, gt_data: DataFile, training_data: DataFile, training_ground_truth: DataFile) -> Benchmark:
            demo = Benchmark(
        ...
        demo_benchmark = create_demo_benchmark(demouser, evaluator, test_data, test_gt_data, training_data, test_gt_data)
