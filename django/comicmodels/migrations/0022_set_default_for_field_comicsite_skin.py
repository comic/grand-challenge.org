...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        if not db.dry_run:
            ...
            default_skin = orm['comicmodels.Comicsite']._meta.get_field_by_name("skin")[0].default
            changed_projects = []
            for project in orm['comicmodels.Comicsite'].objects.all():
                if project.skin == "":                    
                    project.skin = default_skin
                    project.save()
                    changed_projects.append(project.short_name)
                                        
            print "Set .skin to default value '{}' for " \
                   "projects [{}]. ".format(default_skin,",".join(changed_projects))
                                    
                
                
    def backwards(self, orm):
        # cannot go back because you do not know which project.skin="project.css"
        # was filled by a person and which was not. Just leave it be
        pass
    ...
    models = {
        ...
        u'comicmodels.comicsite': {
            ...
            'skin': ('django.db.models.fields.CharField', [], {'default': "'project.css'", 'max_length': '225'}),
