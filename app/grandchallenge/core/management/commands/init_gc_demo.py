...
class Command(BaseCommand):
    ...
    def _create_demo_challenge(self):
        ...
        for phase in demo.phase_set.all():
            ...
            phase.evaluation_detail_observable_url = "https://observablehq.com/embed/@maartenvm/slideable-single-comic-challenge-results-visualization?cell=viewof+submissionNo&cell=viewof+confusion_matrix&cell=viewof+ROC_graph&cell=viewof+summary_stats_table"
