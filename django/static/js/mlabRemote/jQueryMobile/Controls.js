...
// JQMWindowControl
//=============================================================================
function JQMWindowControl(mdlTree, moduleContext) {
  var self = this;
...
// JQMButtonControl
//=============================================================================
function JQMButtonControl(mdlTree, moduleContext) {
  var self = this;
  ...
  this.setup = this.setupButtonControl = function(parentControl) {
    self.setupWidgetControl("JQMButtonControl", parentControl);
    ...
    if (fldName.search("toggle") == 0){
      html = '<select name="slider" id="flip-'+fldName+'" data-role="slider">'+
              '<option value="off">'+title+'Aus</option>'+
              '<option value="on">'+title+'An</option>'+
              '</select>';
      self._button = $(self._domElement).append(html);
    } else {
      self._button = $(self._domElement).append("<a href='#' data-role='button'>"+title+"</a>");
    }
...
// JQMSliderControl
//=============================================================================
function JQMSliderControl(mdlTree, moduleContext) {
  var self = this;
...
// JQMSliderControl
//=============================================================================
function JQMCheckBoxControl(mdlTree, moduleContext) {
  var self = this;
  ...
  this.setup = this.setupCheckBoxControl = function(parentControl) {
    self.setupWidgetControl("JQMCheckBoxControl", parentControl);
...
//=============================================================================
// JQMHorizontalControl
//=============================================================================
function JQMHorizontalControl(mdlTree, moduleContext) {
  var self = this;
  
  this.inheritFrom = MLABHorizontalControl;
  this.inheritFrom(mdlTree, moduleContext);
  
  this.setup = this.setupJQMHorizontalControl = function(parentDomElement) {
...
// JQMVerticalControl
//=============================================================================
function JQMVerticalControl(mdlTree, moduleContext) {
  var self = this;
  
  this.inheritFrom = MLABVerticalControl;
  this.inheritFrom(mdlTree, moduleContext);
  
  this.setup = this.setupJQMVerticalControl = function(parentDomElement) {
...
// JQMComboBoxControl
//=============================================================================
function JQMComboBoxControl(mdlTree, moduleContext) {
  var self = this;
  ...
  this.setup = this.setupComboBoxControl = function(parentControl) {
    self.setupWidgetControl("JQMComboBoxControl", parentControl);
...
//=============================================================================
// JQMRemoteRenderingControl
//=============================================================================
function JQMRemoteRenderingControl(mdlTree, moduleContext) {
  var self = this;
  
  this.inheritFrom = MLABRemoteRenderingControl;
  this.inheritFrom(mdlTree, moduleContext);
  
  this.setup = this.setupJQMRemoteRenderingControl = function(parentDomElement) {
