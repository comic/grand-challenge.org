...
urlpatterns = [
	...
	path("api/patients/", include("grandchallenge.patients.urls", namespace="patients")),
	path("api/studies/", include("grandchallenge.studies.urls", namespace="studies")),
	#url(r'^api/patients', include('grandchallenge.patients.urls')),
	#url(r'^api/studies', include('grandchallenge.studies.urls')),
