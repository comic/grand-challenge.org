const initSelects = () => {
    ...
    for (const el of elements) {
        ...
        searchWidget.classList.toggle("d-none", el.value !== "FILE_SEARCH");
        uploadWidget.classList.toggle("d-none", el.value !== "FILE_UPLOAD");
        ...
        if (!el.dataset.eventListenerAdded) {
            el.addEventListener("change", function () {
                searchWidget.classList.toggle(
                    "d-none",
                    this.value !== "FILE_SEARCH",
                );
                uploadWidget.classList.toggle(
                    "d-none",
                    this.value !== "FILE_UPLOAD",
                );
            });
