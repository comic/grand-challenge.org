...
def test_prepaid_no_utilization_positive_balance():
    ...
    assert invoice.balance_compute_cost_euro_millicents == 2 * 1000 * 100
...
def test_prepaid_utilization_positive_balance():
    ...
    assert invoice.balance_compute_cost_euro_millicents == 1 * 1000 * 100
...
def test_prepaid_no_utilization_zero_balance(payment_status, expires_on):
    ...
    assert invoice.balance_compute_cost_euro_millicents == 0
...
def test_prepaid_overutilization_negative_balance(payment_status):
    ...
    assert invoice.balance_compute_cost_euro_millicents == -3 * 1000 * 100
...
def test_postpaid_no_utilization(
    ...
    assert (
        postpaid_invoice.balance_compute_cost_euro_millicents == 2 * 1000 * 100
    )
...
def test_postpaid_postpaid_status_interaction_zero_balance(
    ...
    assert postpaid_invoice.balance_compute_cost_euro_millicents == 0
...
def test_postpaid_utilized():
    ...
    assert (
        postpaid_invoice.balance_compute_cost_euro_millicents == 3 * 1000 * 100
    )
...
def test_postpaid_overutilized():
    ...
    assert (
        postpaid_invoice.balance_compute_cost_euro_millicents
        == -2 * 1000 * 100
    )
...
def test_multiple_challenges_do_not_mix_prepaid():
    ...
    assert (
        postpaid_invoice.balance_compute_cost_euro_millicents == 1 * 1000 * 100
    )
