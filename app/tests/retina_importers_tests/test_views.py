...
batch_test_data = {
    ...
    "upload_measurement": {
        ...
        "url": reverse("retina:importers:upload-measurement_annotation"),
        "annotation_data": True,
    },
    "upload_boolean_annotation": {
        ...
        "url": reverse("retina:importers:upload-boolean-classification-annotation"),
        "annotation_data": True,
    },
    "upload_polygon_annotation": {
        ...
        "url": reverse("retina:importers:upload-polygon-annotation"),
        "annotation_data": True,
    },
    "upload_landmark_annotation": {
        ...
        "url": reverse("retina:importers:upload-image-registration-landmarks"),
        "annotation_data": True,
    }
}
