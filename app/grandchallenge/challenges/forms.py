...
class ChallengeRequestForm(forms.ModelForm):
    class Meta:
        ...
        help_texts = {
            "challenge_short_name": "Short name that will be used in the URL "
            ...
            "topic from both a biomedical as well as from a technical point of view. "
            "From a biomedical point of view, please elaborate on the "
            ...
            "challenge_type": "<b>Type 1 :</b> Prediction submission - "
            ...
            "for example by asking participants to publish their Github repo under an"
            "<a href='https://docs.github.com/en/repositories/managing-your-"
            "repositorys-settings-and-features/customizing-your-repository/"
            "licensing-a-repository' target='_blank'> open source license</a> "
            "(e.g., Apache 2.0, MIT) and <a href="
            ...
            "'https://grand-challenge.org/documentation/data-storage/' target='_blank'"
            ">here</a>).<br>For Type 2 challenges, the test dataset will need "
            "to be uploaded to Grand Challenge (read more about that <a href="
            "'https://grand-challenge.org/documentation/data-storage-2/'"
            "target='_blank'>here</a>).",
            "structured_challenge_submission_form": "Have you registered this challenge"
            ...
            "number_of_tasks": "If your challenge has multiple tasks, we multiply"
            ...
            "here</a>.",
            "challenge_setup": "Describe the challenge set-up. How many tasks "
