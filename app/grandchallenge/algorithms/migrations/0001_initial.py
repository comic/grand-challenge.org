    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.FileField(help_text='Tar archive of the container image produced from the command `docker save IMAGE > IMAGE.tar`. See https://docs.docker.com/engine/reference/commandline/save/', upload_to=grandchallenge.container_exec.models.docker_image_path, validators=[grandchallenge.core.validators.ExtensionValidator(allowed_extensions=('.tar',))])),
