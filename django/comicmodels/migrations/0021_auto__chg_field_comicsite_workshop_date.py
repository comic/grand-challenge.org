...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ComicSite.workshop_date'
        db.alter_column(u'comicmodels_comicsite', 'workshop_date', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # Changing field 'ComicSite.workshop_date'
        db.alter_column(u'comicmodels_comicsite', 'workshop_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
