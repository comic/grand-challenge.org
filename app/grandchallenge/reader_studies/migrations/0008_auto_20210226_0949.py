# Generated by Django 3.1.6 on 2021-02-26 09:49
...
IMAGE_PORT_EMPTY_PLACEHOLDER = 9


def remap_image_ports(apps, _):
    question = apps.get_model("reader_studies", "Question")
    # Migration does not pick up "" and sets this to NULL, so using a placeholder here.
    remap = {"": IMAGE_PORT_EMPTY_PLACEHOLDER, "M": "0", "S": "1"}
    for question in question.objects.all():
        question.image_port = remap[question.image_port]
        question.save()


def clear_placeholder(apps, _):
    question = apps.get_model("reader_studies", "Question")
    for question in question.objects.filter(
        image_port=IMAGE_PORT_EMPTY_PLACEHOLDER
    ):
        question.image_port = None
        question.save()
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(remap_image_ports),
        ...
        migrations.RunPython(clear_placeholder),
        migrations.AlterField(
