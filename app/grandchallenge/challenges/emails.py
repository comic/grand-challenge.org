...
def send_challenge_status_update_email(challengerequest, challenge=None):
    ...
    if (
        ...
        message = format_html(
            ...
            "4. IMPORTANT: To enable algorithm submission for your challenge phases, "
            "we need to know which input and output interfaces the algorithms "
            "submitted to your challenge require. You can read more about interfaces "
            "here: https://grand-challenge.org/documentation/choose-input-and-output-interfaces/. "
            "Please let us know which interfaces you will need so we can configure"
            "your phases accordingly and create archives for each of your phases. "
            "Only after the interfaces have been defined will you be able to upload "
            "your data and set up your evaluation container.\n\n"
