...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UploadModel.created'
        db.alter_column('comicmodels_uploadmodel', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'UploadModel.modified'
        db.alter_column('comicmodels_uploadmodel', 'modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        #unrelated: set filesystemdatasetpermissions right again
        db.send_create_signal('comicmodels', ['filesystemdataset'])

    def backwards(self, orm):

        # Changing field 'UploadModel.created'
        db.alter_column('comicmodels_uploadmodel', 'created', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

        # Changing field 'UploadModel.modified'
        db.alter_column('comicmodels_uploadmodel', 'modified', self.gf('django.db.models.fields.DateField')(auto_now=True))
