...
@pytest.mark.parametrize(
    "answer_type, choices",
    (
        (AnswerType.SINGLE_LINE_TEXT, [("", "Default")]),
        (AnswerType.MULTI_LINE_TEXT, [("", "Default")]),
        (AnswerType.BOOL, [("", "Default")]),
        (AnswerType.NUMBER, [("", "Default")]),
        (AnswerType.POINT, [("", "Default")]),
        (
            AnswerType.MULTIPLE_POINTS,
            [("", "Default"), ("ACCEPT_REJECT", "Accept/Reject Findings")],
        ),
        (AnswerType.BOUNDING_BOX_2D, [("", "Default")]),
        (
            AnswerType.MULTIPLE_2D_BOUNDING_BOXES,
            [("", "Default"), ("ACCEPT_REJECT", "Accept/Reject Findings")],
        ),
        (AnswerType.DISTANCE_MEASUREMENT, [("", "Default")]),
        (
            AnswerType.MULTIPLE_DISTANCE_MEASUREMENTS,
            [("", "Default"), ("ACCEPT_REJECT", "Accept/Reject Findings")],
        ),
        (AnswerType.POLYGON, [("", "Default")]),
        (
            AnswerType.MULTIPLE_POLYGONS,
            [("", "Default"), ("ACCEPT_REJECT", "Accept/Reject Findings")],
        ),
        (AnswerType.LINE, [("", "Default")]),
        (
            AnswerType.MULTIPLE_LINES,
            [("", "Default"), ("ACCEPT_REJECT", "Accept/Reject Findings")],
        ),
        (AnswerType.ANGLE, [("", "Default")]),
        (
            AnswerType.MULTIPLE_ANGLES,
            [("", "Default"), ("ACCEPT_REJECT", "Accept/Reject Findings")],
        ),
        (AnswerType.ELLIPSE, [("", "Default")]),
        (
            AnswerType.MULTIPLE_ELLIPSES,
            [("", "Default"), ("ACCEPT_REJECT", "Accept/Reject Findings")],
        ),
        (AnswerType.CHOICE, [("", "Default")]),
        (AnswerType.MULTIPLE_CHOICE, [("", "Default")]),
        (AnswerType.MULTIPLE_CHOICE_DROPDOWN, [("", "Default")]),
        (AnswerType.MASK, [("", "Default")]),
    ),
)
