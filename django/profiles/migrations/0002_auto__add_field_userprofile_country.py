...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('profiles_userprofile', 'country',
                      self.gf('django_countries.fields.CountryField')(default=u'NL', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.country'
        db.delete_column('profiles_userprofile', 'country')
    ...
    models = {
        ...
        'profiles.userprofile': {
            ...
            'country': ('django_countries.fields.CountryField', [], {'default': "u'NL'", 'max_length': '2'}),
            ...
            'website': ('django.db.models.fields.CharField', [], {'max_length': '150'})
        }
    }
