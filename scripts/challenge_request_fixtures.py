...
def run():
    ...
    ChallengeRequest.objects.create(
        ...
        number_of_teams_for_phases=[fake.random_int(10, 50, 5)] * 3,
        inference_time_average_minutes_for_phases=[fake.random_int(5, 60)] * 3,
        average_size_test_image_mb_for_phases=[fake.random_int(1, 1024)] * 3,
        ...
        algorithm_maximum_settable_memory_gb_for_phases=[32, 32, 32],
        data_license=True,
