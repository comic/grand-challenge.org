...
urlpatterns = [
    ...
    path("pathology/patient_items/remove/<uuid:pk>/", views.PatientItemRemoveView.as_view(), name="patient-item-remove"),
    path("pathology/patient_items/update/<uuid:pk>/", views.PatientItemUpdateView.as_view(), name="patient-item-update"),
    ...
    path("pathology/study_items/remove/<uuid:pk>/", views.StudyItemRemoveView.as_view(), name="study-item-remove"),
    path("pathology/study_items/update/<uuid:pk>/", views.StudyItemUpdateView.as_view(), name="study-item-update"),
    ...
    path("pathology/worklist_items/remove/<uuid:pk>/", views.WorklistItemRemoveView.as_view(), name="worklist-item-remove"),
    path("pathology/worklist_items/update/<uuid:pk>/", views.WorklistItemUpdateView.as_view(), name="worklist-item-update"),
