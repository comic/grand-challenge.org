...
def copy_ada_annotations_to_demo_forward(apps, schema_editor):
    ...
    BooleanClassification = apps.get_model('annotations', 'BooleanClassificationAnnotation')
    PolygonAnnotationSet = apps.get_model('annotations', 'PolygonAnnotationSet')
    SinglePolygon = apps.get_model('annotations', 'SinglePolygonAnnotation')
    LandmarkAnnotationSet = apps.get_model('annotations', 'LandmarkAnnotationSet')
    ...
    for model in (Measurement, BooleanClassification, PolygonAnnotationSet, LandmarkAnnotationSet, ETDRSGrid):
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunPython(copy_ada_annotations_to_demo_forward, copy_ada_annotations_to_demo_backward)
    ]
