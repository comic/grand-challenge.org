...
CHALLENGES_S3_STORAGE_COST_CENTS_PER_TB_PER_YEAR = os.environ.get(
    "CHALLENGES_S3_STORAGE_COST_CENTS_PER_TB_PER_YEAR", 27600
)
# based on 0.10 / GB / month ECR pricing
CHALLENGES_ECR_STORAGE_COST_CENTS_PER_TB_PER_YEAR = os.environ.get(
    "CHALLENGES_ECR_STORAGE_COST_CENTS_PER_TB_PER_YEAR", 120000
)
