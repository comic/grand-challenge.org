...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ComicSite.disclaimer'
        db.add_column(u'comicmodels_comicsite', 'disclaimer',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ComicSite.disclaimer'
        db.delete_column(u'comicmodels_comicsite', 'disclaimer')
    ...
    models = {
        ...
        u'comicmodels.comicsite': {
            ...
            'disclaimer': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2048', 'blank': 'True'}),
