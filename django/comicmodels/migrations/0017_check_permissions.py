...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """ The check_permissions management command solves some bugs in 
        userena. We ran it manually before, but for testing, and general coding
        style, I do it here automatically now. See 
        https://github.com/comic/comic-django/issues/28. 
        """
