...
def update_evaluation_inputs(apps, _schema_editor):
    ...
    evaluations = Evaluation.objects.prefetch_related("inputs").iterator(
    ...
    for evaluation in evaluations:
        ...
        if len(updated_evaluations) >= batch_size:
            Evaluation.objects.bulk_update(updated_evaluations, ["input_set"])
            updated_evaluations = []

    if updated_evaluations:
        Evaluation.objects.bulk_update(evaluations, ["input_set"])
