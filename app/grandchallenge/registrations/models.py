...
class OctObsRegistration(UUIDModel):
    ...
    obs_image = models.ForeignKey(Image, related_name="obs_image", on_delete=models.CASCADE)
    oct_series = models.ForeignKey(Image, related_name="oct_image", on_delete=models.CASCADE)
