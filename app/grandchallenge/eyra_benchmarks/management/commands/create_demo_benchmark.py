...
from grandchallenge.eyra_algorithms.models import Input, Implementation, Interface
...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        def create_evaluator(user: User, interface: Interface) -> Implementation:
            algo = Implementation(
                creator=user,
        ...
        def create_demo_benchmark(user: User, evaluator: Implementation, test_data: DataFile, gt_data: DataFile, training_data: DataFile, training_ground_truth: DataFile, interface: Interface) -> Benchmark:
            demo = Benchmark(
        ...
        def create_predictor(user: User, interface: Interface) -> Implementation:
            algo = Implementation(
                creator=user,
                name='Algorithm A',
        ...
        def create_submission(user: User, benchmark: Benchmark, predictor: Implementation) -> Submission:
