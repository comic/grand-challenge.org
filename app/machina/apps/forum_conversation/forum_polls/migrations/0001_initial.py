        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "question",
                    models.CharField(
                        max_length=255, verbose_name="Poll question"
                    ),
                ),
                (
                    "duration",
                    models.PositiveIntegerField(
                        null=True,
                        verbose_name="Poll duration, in days",
                        blank=True,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "text",
                    models.CharField(
                        max_length=255, verbose_name="Poll option text"
                    ),
                ),
                (
                    "poll",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "timestamp",
                    models.DateTimeField(
                        auto_now_add=True, verbose_name="Vote's date"
                    ),
                ),
                (
                    "poll_option",
