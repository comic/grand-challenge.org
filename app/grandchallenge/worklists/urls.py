...
urlpatterns = [
    path(
        "worklists/worklists/", views.WorklistTable.as_view(), name="worklists"
    ),
    path(
        "worklists/worklists/<uuid:pk>/",
        views.WorklistRecord.as_view(),
        name="worklist",
    ),
    path(
