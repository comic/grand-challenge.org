...
def send_challenge_status_update_email(challengerequest, challenge=None):
    ...
    if (
        ...
        message = (
            ...
            f"Note that your challenge is currently still hidden and is not yet "
            f"listed on our challenge overview page. Once your challenge is "
            f"all set-up, you can make it public by going to Admin - General "
            f"Settings and unchecking the 'hidden' box. \n"
