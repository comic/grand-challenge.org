...
MLAB.JQuery.deriveClass("Slider", MLAB.GUI.Slider, {
  ...
  _createDOMElement: function() {
    ...
    this._slider.slider({
        ...
        max: this._maxmumValue,
        step: 1,
        animate: true,
        slide: this.callback("_onSliderChange"),
        start: this.callback("_onSlideStart"),
        stop: this.callback("_onSlideEnd")
    });
  ...
  _getSliderValue: function() {
    return this._mapValueFromJQuerySlider(this._slider.slider("value"))
  },
