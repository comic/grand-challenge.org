        ...
        1: [
            function (require, module, exports) {
                ...
                function updateHeight(editor) {
                    if (editor.scrollTop)
                        editor.style.height =
                            editor.scrollTop + getHeight(editor) + "px";
                    return editor;
                }
                var MarkdownX = function (parent, editor, preview) {
                    ...
                    var _initialize = function () {
                        ...
                        properties.editor.setAttribute(
                            "data-markdownx-init",
                            "",
                        );
                        properties.editor.style.transition = "opacity 1s ease";
                        properties.editor.style.webkitTransition =
                            "opacity 1s ease";
                        properties._latency = Math.max(
                            parseInt(
                                properties.editor.getAttribute(
                                    LATENCY_ATTRIBUTE,
                                ),
                            ) || 0,
                            LATENCY_MINIMUM,
                    ...
                    var onDrop = function (event) {
                        if (
                            ...
                            Object.keys(event.dataTransfer.files).map(
                                function (fileKey) {
                                    return sendFile(
                                        event.dataTransfer.files[fileKey],
                                    );
                                },
                            );
                    ...
                    var onKeyDown = function (event) {
                        ...
                        properties.editor.selectionEnd =
                            properties.editor.selectionStart = SELECTION_START;
                        return false;
                    };
        ...
        2: [
            function (require, module, exports) {
                ...
                function AJAXRequest() {
                    ...
                    throw new TypeError(
                        "This browser does not support AJAX requests.",
                    );
                }
