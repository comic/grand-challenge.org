...
push_web_test:
	docker push $(GRAND_CHALLENGE_WEB_TEST_REPOSITORY_URI):$(GIT_COMMIT_ID)-$(GIT_BRANCH_NAME)-$(POETRY_HASH)
	docker push $(GRAND_CHALLENGE_WEB_TEST_REPOSITORY_URI):latest
