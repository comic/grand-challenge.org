    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('challenge', models.OneToOneField(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='evaluation_config', to='comicmodels.ComicSite')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('challenge', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='comicmodels.ComicSite')),
            ],
            options={
                'abstract': False,
            },
