    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.CharField(help_text='The version of this algorithm (within a Solution)', max_length=64)),
        ...
        migrations.AddField(
            model_name='algorithm',
            name='solution',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='algorithms', to='eyra_algorithms.Solution'),
        ),
    ]
